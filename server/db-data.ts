...
export function authenticate(email: string, password: string) {
  ...
  /* 
    ...
    22: {
      "id": 22,
      'description': 'Course Kick-Off - Install Node, NPM, "id"E And Service Workers Section Code',
      "duration": '07:19',
      "seqNo": 1,
      "courseid": 7
    },
    ...
    35: {
      "id": 35,
      description: 'Firestore Unique "id"entifiers',
      "duration": '4:38',
      "seqNo": 6,
      "courseid": 1
    },
  ...
  // Angular Testing Course
    ...
    55: {
      "id": 55,
      'description': 'Un"id"irectional Data Flow And The Angular Development Mode',
      "duration": '7:07',
      "seqNo": 6,
      "courseid": 4
    },
    ...
    66: {
      "id": 66,
      'description': 'NestJs M"id"dleware',
      "duration": '7:08',
      "seqNo": 7,
      "courseid": 14
    },
    ...
    110: {
      "id": 110,
      'description': 'Exercise - Implement a W"id"get Dashboard',
      "duration": '07:50',
      "seqNo": 21,
      "courseid": 18,
      v"id"eo"id": 'VES1eTNxi1s'
    ...
    121: {
      ...
      "seqNo": 2,
      "courseid": 11,
      "longDescription": "Gu"id"ed tour of navigation elements and container."
    },
    122: {
      "id": 122,
      'description': 'Data Tables',
